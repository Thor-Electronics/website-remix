...
export const Button = ({ children, className, ...props }: Props) => (
  <button
    ...
    className={`btn bg-slate-400 dark:bg-slate-600 text-white
      transition-all shadow-md rounded-md dark:highlight-white/5 flex
      flex-row items-center justify-center gap-1 ${className}`}
    {...props}
  >
    {children}
  </button>
