...
export const ManageAccess = () => {
  ...
  return (
    <div className="ManageAccess admin-page">
      ...
      <nav className="access-management flex gap-2 justify-center font-semibold text-white">
        <Link
          to="/admin/access-management"
          className="bg-white shadow rounded-lg py-2 px-4 grow text-center"
        >
          Manufacturers
        </Link>
        <Link
      ...
      <Outlet />
      <p className="roles text-xs font-semibold text-slate-400 text-center">
        Signed in as{" "}
        {user.roles?.map(r => (
